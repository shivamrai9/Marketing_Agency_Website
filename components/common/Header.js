    ...
    <>
      <header>
        <div className='container'>
          <div className='logo'>
            <Link href='/'>
              <TitleLogo title='KALAKAR' caption='Design' className='logomin' />
            </Link>
          </div>
          ...
          <button onClick={() => setOpen(!open)} className="sidebarTgButton" >{open ? <AiOutlineClose size={25} /> : <RiMenu4Line size={25} />}</button>
        </div>
      </header>
    </>
  )
